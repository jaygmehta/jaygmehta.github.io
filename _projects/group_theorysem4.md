...
description: Semester IV (PS04EMTH57) <br>
             same as Sem III (PS03EMTH54)
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text1">Video Lecture 01</button>
    ...
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text2">Video Lecture 02</button>
    ...
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text3">Video Lecture 03</button>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text4">Video Lecture 04</button>
    ...
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text5">Video Lecture 05</button>
    ...
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text6">Video Lecture 06</button>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text7">Video Lecture 07</button>
        <div id="text7" class="collapse">
        We discuss the result that if \(G\) is a group and \(H, K\) are finite subgroups of G, then o(HK) = (o(H).o(K))/(o(H \cap K)). The motivation/intuition based on examples related to this result was discussed at the end of the last video. Furthermore, we prove that if \(G\) is a group of order \(pq\) (product of two primes) and \(p > q\), then \(G\) has at most one subgroup of order \(p\).
        </div>
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include video.html path="https://youtube.com/embed/0mHVIPGINA8" class="img-fluid rounded z-depth-1" %}
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text8">Video Lecture 08</button>
    ...
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text9">Video Lecture 09</button>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text10">Video Lecture 10</button>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text11">Video Lecture 11</button>
    ...
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text12">Video Lecture 12</button>
    ...
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text13">Video Lecture 13</button>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text14">Video Lecture 14</button>
    ...
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text15">Video Lecture 15</button>
    ...
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text16">Video Lecture 16</button>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text17">Video Lecture 17</button>
    ...
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text18">Video Lecture 18</button>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text19">Video Lecture 19</button>
    ...
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text20">Video Lecture 20</button>
    ...
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text21">Video Lecture 21</button>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        ...
        <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#text22">Video Lecture 22</button>
...
<!-- <object data="https://jaygmehta.com/assets/pdf/PS04EMTH57.pdf" type="application/pdf" width="100%" height="800">
    <embed src="https://jaygmehta.com/assets/pdf/PS04EMTH57.pdf">
        <p>This browser does not support PDFs. Please download the PDF to view it: <a href="https://jaygmehta.com/assets/pdf/PS04EMTH57.pdf">Download PDF</a>.</p>
    </embed>
</object> -->