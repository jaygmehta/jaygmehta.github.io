...
<form  onsubmit="return passcheck()">
	...
	<span style="font-size: 15px; font-weight: bold; font-family: 'Noto Sans', sans-serif; margin-right: 15px;">To download the Workshop (NWPSM-XIV) Session Transcript, click below:<br/> Enter Password: </span>
...
<h3>July 2025 (Part B) Q-37</h3>
  <p>
  <h5>
Which of the following statements is true?</h5>
  <!-- <p>Choose 1 answer</p> -->
  <hr />

  <div id='block-july2025op1' style='padding: .5px;'>
    <label for='option-july2025op1' style=' padding: .5px; font-size: 1rem;'>
      <input type='radio' name='option' id='option-july2025op1' style='transform: scale(1.5); margin-right: 10px; vertical-align: middle; margin-top: -1px;' />
      $p\mid 1 + (p-1)!$ for some odd prime $p$</label>
  </div>
  <hr />

  <div id='block-july2025op2' style='padding: .5px;'>
    <label for='option-july2025op2' style=' padding: .5px; font-size: 1rem;'>
      <input type='radio' name='option' id='option-july2025op2' style='transform: scale(1.5); margin-right: 10px; vertical-align: middle; margin-top: -1px;' />
      $p \mid (1234)^{p-1} - 1$ for all primes $p > 700$.</label>
  </div>
  <hr />

  <div id='block-july2025op3' style='padding: .5px;'>
    <label for='option-july2025op3' style=' padding: .5px; font-size: 1rem;'>
      <input type='radio' name='option' id='option-july2025op3' style='transform: scale(1.5); margin-right: 10px; vertical-align: middle; margin-top: -1px;' />
      There exists $a \in \mathbb Z$ and a prime $p > 11$ such that $p \nmid a^p - a$.</label>
  </div>
  <hr />

  <div id='block-july2025op4' style='padding: .5px;'>
    <label for='option-july2025op4' style=' padding: .5px; font-size: 1rem;'>
      <input type='radio' name='option' id='option-july2025op4' style='transform: scale(1.5); margin-right: 10px; vertical-align: middle; margin-top: -1px;' />
      $p \nmid \frac{(p^2)!}{(p!)^2}$ for some odd prime $p$.</label>
  </div>
  <hr />
  <button type='button' onclick='displayAnswerjuly2025()' style='width: 100px; height: 40px; border-radius: 3px; background-color: lightblue; font-weight: 700;'>Submit</button>
  <div id="rjuly2025Correct" class="riHide ri-alert-success">
    Correct
  </div>
  <div id="rjuly2025Incorrect" class="riHide ri-alert-danger">
    In-correct
  </div>
...
Which of the following statements is true?</h5>
  ...
  <div id='block-mar2025op1' style='padding: .5px;'>
    <label for='option-mar2025op1' style=' padding: .5px; font-size: 1rem;'>
      <input type='radio' name='option' id='option-mar2025op1' style='transform: scale(1.5); margin-right: 10px; vertical-align: middle; margin-top: -1px;' />
      For each $p<100$,
  ...
  <div id='block-mar2025op2' style='padding: .5px;'>
    <label for='option-mar2025op2' style=' padding: .5px; font-size: 1rem;'>
      <input type='radio' name='option' id='option-mar2025op2' style='transform: scale(1.5); margin-right: 10px; vertical-align: middle; margin-top: -1px;' />
      For each $100 \le p \le 200$,
$
\sum_{n=1}^{\infty}\left(\frac{S_p}{\varphi(p)}\right)^n
$
diverges.</label>
  ...
  <div id='block-mar2025op3' style='padding: .5px;'>
    <label for='option-mar2025op3' style=' padding: .5px; font-size: 1rem;'>
      <input type='radio' name='option' id='option-mar2025op3' style='transform: scale(1.5); margin-right: 10px; vertical-align: middle; margin-top: -1px;' />
      For each $p>200$,
$
\sum_{n=1}^{\infty}\left(\frac{S_p}{\varphi(p)}\right)^n
$
converges.</label>
  ...
  <div id='block-mar2025op4' style='padding: .5px;'>
    <label for='option-mar2025op4' style=' padding: .5px; font-size: 1rem;'>
      <input type='radio' name='option' id='option-mar2025op4' style='transform: scale(1.5); margin-right: 10px; vertical-align: middle; margin-top: -1px;' />
      The element $4 \bmod 101$ in $(\mathbb{Z}/101\mathbb{Z})^\times$ is a primitive root.</label>
  </div>
  <hr />
  <button type='button' onclick='displayAnswermar2025()' style='width: 100px; height: 40px; border-radius: 3px; background-color: lightblue; font-weight: 700;'>Submit</button>
  <div id="rmar2025Correct" class="riHide ri-alert-success">
    Correct
  </div>
  <div id="rmar2025Incorrect" class="riHide ri-alert-danger">
    In-correct
  </div>
...
function displayAnswerjuly2025() {
    rjuly2025_addClass(document.getElementById('rjuly2025Correct'), 'riHide', );
  rjuly2025_addClass(document.getElementById('rjuly2025Incorrect'), 'riHide', );
    if (!document.getElementById('option-july2025op1').checked
    && document.getElementById('option-july2025op2').checked
    && !document.getElementById('option-july2025op3').checked
    && !document.getElementById('option-july2025op4').checked
    ) {
      rjuly2025_removeClass(document.getElementById('rjuly2025Correct'), 'riHide', )
    }
    else {
    rjuly2025_removeClass(document.getElementById('rjuly2025Incorrect'), 'riHide', );
  }
  }
   function rjuly2025_hasClass(ele, cls) {
  return !!ele.className.match(new RegExp('(\\s|^)' + cls + '(\\s|$)'));
}
function rjuly2025_addClass(ele, cls) {
  if (!rjuly2025_hasClass(ele, cls)) ele.className += " " + cls;
}
    function rjuly2025_removeClass(ele, cls) {
  if (rjuly2025_hasClass(ele, cls)) {
    var reg = new RegExp('(\\s|^)' + cls + '(\\s|$)');
    ele.className = ele.className.replace(reg, ' ');
  }
}

  function displayAnswermar2025() {
    rmar2025_addClass(document.getElementById('rmar2025Correct'), 'riHide', );
  rmar2025_addClass(document.getElementById('rmar2025Incorrect'), 'riHide', );
    if (!document.getElementById('option-mar2025op1').checked
    && !document.getElementById('option-mar2025op2').checked
    && document.getElementById('option-mar2025op3').checked
    && !document.getElementById('option-mar2025op4').checked
    ) {
      rmar2025_removeClass(document.getElementById('rmar2025Correct'), 'riHide', )
    }
    else {
    rmar2025_removeClass(document.getElementById('rmar2025Incorrect'), 'riHide', );
  }
  }
   function rmar2025_hasClass(ele, cls) {
  return !!ele.className.match(new RegExp('(\\s|^)' + cls + '(\\s|$)'));
}
function rmar2025_addClass(ele, cls) {
  if (!rmar2025_hasClass(ele, cls)) ele.className += " " + cls;
}
    function rmar2025_removeClass(ele, cls) {
  if (rmar2025_hasClass(ele, cls)) {
    var reg = new RegExp('(\\s|^)' + cls + '(\\s|$)');
    ele.className = ele.className.replace(reg, ' ');
  }
}
...
<script>
	...
	function passcheck(){
      ...
      window.open("https://www.dropbox.com/scl/fi/b5jdrqah663mbniyqr3gl/SPU_Workshop_03_Feb_2026_Transcript.pdf?rlkey=14pmnvlzeureb1kc35l7fxd93&st=49w9sy76&dl=1");
		}
